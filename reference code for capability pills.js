    ...
    function initPhysics(conainer) {
      ...
      const walls = [
          Matter.Bodies.rectangle(
            ...
            containerRect.width + wallThickness * wallThickness * 2,
            wallThickness,
            { isStatic: true }
          ),
          Matter.Bodies.rectangle(
      ...
      const mouse = Matter.Mouse.create(conainer);
      ...
      Matter.Events.on(engine, "beforeUpdate", function () {
        if (dragging) {
          ...
          if (found) {
            ...
            const maxY = constainerRect.height - found.height / 2;
